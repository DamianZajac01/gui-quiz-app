...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.green_button = Button(image=green_button_image, highlightthickness=0, command=self.correct_answer)
        self.green_button.grid(column=0, row=2)

        red_button_image = PhotoImage(file="images/false.png")
        self.red_button = Button(image=red_button_image, highlightthickness=0, command=self.wrong_answer)
